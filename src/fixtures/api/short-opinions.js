  ...
  'data': [
    {
      ...
      'attributes': {
        'image': {
          ...
          'height': 400,
          'width': 1080,
          'url': 'https://coda.io/contentProxy/dYI4sySQOr/blobs/bl-bcDQBd0G4D/d396edc88a3157fdc9dcfec49346fa6d369ef8996d0dce56e9c7e1bca191d77c4c199ea7c3421c05e7d6634e3e4dd5ea0ac1dcf0abd56a243f07a840cd8f9e19d129652ade52aa5b475ed9ecccd9d111948c7d1ba8b35bc5229747795564615090f3a3c5',
          'status': 'live'
        },
        'imageDescription': '<p>&quot;Do we all have a destiny, or are we floating around accidental - like on a breeze. Maybe it\'s both&quot; - Forrest Gump</p>\n',
        'createdOn': '2020-03-19T14:41:13.911-07:00',
        'publishedOn': '2020-03-20T21:00:00.000-07:00',
        'link': {
          '@context': 'http://schema.org/',
          '@type': 'WebPage',
          'url': 'http://johnsalvatier.org/blog/2017/reality-has-a-surprising-amount-of-detail'
        },
        'notes': '<p>have heard agile development used to defend a lot of seemingly bad processes, and especially bad outcomes. The iterative nature of agile development does imply repeatedly fixing some early mistake or misconception - the evolution of your production.</p>\n<p>However, I have often times thought there were very many mistakes we could have avoided by spending time up front to look at the whole project ahead. Unfortunately that sounds a lot like &quot;waterfall&quot;, which makes people cringe. It shouldn\'t.</p>\n<p>This article is about coming to terms with the innumerable complexities and details involved in any project (some surprisingly simple). The author expounds on how best to spot <strong>future</strong> challenges early on, so to arrive at them with tactical solutions. The lesson is in how to better perceive the project details that lie ahead. It\'s about clarity of vision. And, I believe that giving thought to more functional and technical requirements up front is the first step towards achieving clarity. Another, is to get varied perspectives from all the different people you work with.</p>\n<p>Waterfall should not itself be the process - it should be an approach used to <strong>inform</strong> the real software development process, the agile one</p>\n',
        'quote': '<p>Seek detail you would not normally notice about the world. When you go for a walk, notice the unexpected detail in a flower or what the seams in the road imply about how the road was built.</p>\n',
        'title': '<p>Add some waterfall to your agile</p>\n'
      }
    },
    {
      'id': 'i-jSKq1AHXdq',
      ...
      'attributes': {
        'image': {
          ...
          'height': 1070,
          'width': 891,
          'url': 'https://coda.io/contentProxy/dYI4sySQOr/blobs/bl-0Ge8ox0R4e/68ef63d00dda01ac48b69958dfddb0f1a0776c3506a337aaa1c70f26492c07fd31e10e4a9e2b57684b5f90faee76168003f595470f05d457b1498cdc858fb60f0edf7ac470458eb6a1b24aa1c06eda10c8b5f8cac24e462c0eb96cc894b3eb349ddecf05',
          'status': 'live'
        },
        'imageDescription': '<p>Fred Astaire and Ginger Rogers in <em>Shall We Dance</em>. You say either.. I nyther. Maybe &quot;Let\'s call the whole thing off.&quot;</p>\n',
        'createdOn': '2020-03-19T14:14:34.017-07:00',
        'publishedOn': '2020-03-19T21:00:00.000-07:00',
        'link': {
          '@context': 'http://schema.org/',
          '@type': 'WebPage',
          'url': 'https://sobolevn.me/2020/03/do-not-log'
        },
        'notes': '<p>t seems sometimes that however you approach logging is going to lead to disaster:</p>\n<ul>\n<li>Say you avoid logging in production (as many linters would force you to do). I can think of plenty of times I wished we <strong>had</strong> them.</li>\n<li>Ok, start logging. Then, you drown in them - the noise suffocates the signal.</li>\n<li>You decide you need to make intelligent architecture decisions about what to log, and where to put them. That takes a lot of brainpower. And, you wonder how might you avoid such complexities.</li>\n</ul>\n<p>I\'ve no answer to these tribulations. I\'ve yet to see a system demonstrating the best practices of logging. <a href="https://www.twitter.com/morgs32">Let me know</a> if you have</p>\n',
        'quote': null,
        'title': '<p>Be careful how you log</p>\n'
      }
    },
    {
      'id': 'i-_ly2IFtrBq',
    ...
    },
    {
      ...
      'attributes': {
        'image': {
          ...
          'height': 800,
          'width': 700,
          'url': 'https://coda.io/contentProxy/dYI4sySQOr/blobs/bl-SthHDYhcAH/1984ac1ac4d7f751ca73f481a573a5e5a88751a53e7ada9fa893e136176f28e04c832eef6ca955b98db7bd28c29f6c53f9bc5510c60abff1bbdd4e3ec0a4112f27b168512c8e0c34f6d5b65bbd0bc0f2492839c3371a6c8c1e88c4faec2e613a4514f892',
          'status': 'live'
        },
        'imageDescription': '<p>Doctor Evil and Mini Me from Austin Powers. Watch out that your cards don\'t end up being &quot;mini web pages&quot;.</p>\n',
    ...
    },
    {
      ...
      'attributes': {
        ...
        'link': '',
        'notes': '<p>Ask yourself, what is your users primary hesitation? Then explicitly and directly address it.</p>\n',
        'quote': null,
