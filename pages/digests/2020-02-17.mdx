# [A design challenge with Ryan Singer](https://www.pluralsight.com/courses/play-by-play-ryan-singer)
...
# [This is how you ask to email your customers](https://github.com/marcintreder/adele)

![A screenshot of Volument asking for my email address](/images/HowToAskForEmail.png)

Ask yourself, what is your users primary hesitation? Then explicitly and directly address it.

# [A teardown of MongoDb vs Postgres](https://www.enterprisedb.com/blog/comparison-joins-mongodb-vs-postgresql)
...
# [Practice your compound components](https://medium.com/@Dane_s/react-js-compound-components-a6e54b5c9992)
