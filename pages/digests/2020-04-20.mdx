# [AMP Real URLs](https://blog.cloudflare.com/announcing-amp-real-url/)
...
# [Cloudflare makes a local dev environment for workers](https://blog.cloudflare.com/trailblazing-a-development-environment-for-workers/)
...
# [Using composition with stateless UI components](https://itnext.io/react-hooks-inverting-container-presenter-5758a1dfdaa)
